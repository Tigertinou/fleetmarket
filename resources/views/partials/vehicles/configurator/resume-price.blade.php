<x-utils.box color="gray" class="w-full text-sm">
    <b class="font-bold">{{ __tl('Prix total') }}</b>
    <div class="flex">
    ...
    <div class="flex" x-show="total.shipping">
        <div class="flex-1">{{ __tl('Frais de livraison incluant la contribution environnementale pour le recyclage de la voiture') }}</div>
