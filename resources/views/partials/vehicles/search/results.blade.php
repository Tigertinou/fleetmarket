                    ...
                    <p class="text-xs leading-5">
                        ...
                        @if(isset($vehicle['summary']['co2']['min']))
                            <span class="mr-2 pr-2 border-r last:border-r-0 border-gray-400">
                                ...
                                {{ isset($vehicle['summary']['co2']['max']) ? ' - ' . $vehicle['summary']['co2']['min'] : '' }}</b>
                        ...
                        @if(isset($vehicle['summary']['wltpEmissionsCombined']['min']))
                            <span class="mr-2 pr-2 border-r last:border-r-0 border-gray-400">
                                ...
                                {{ isset($vehicle['summary']['wltpEmissionsCombined']['max']) ? ' - ' . $vehicle['summary']['wltpEmissionsCombined']['min'] : '' }}</b>
                        ...
                        @if(isset($vehicle['summary']['wltpConsumptionCombined']['min']))
                            <span class="mr-2 pr-2 border-r last:border-r-0 border-gray-400">
                                ...
                                {{ isset($vehicle['summary']['wltpConsumptionCombined']['max']) ? ' - ' . $vehicle['summary']['wltpConsumptionCombined']['min'] : '' }}</b>
                        ...
                        @if(isset($vehicle['summary']['wltpElectricRangeCombinedKm ']['min']))
                            <span class="mr-2 pr-2 border-r last:border-r-0 border-gray-400">
                                ...
                                {{ isset($vehicle['summary']['wltpElectricRangeCombinedKm ']['max']) ? ' - ' . $vehicle['summary']['wltpElectricRangeCombinedKm ']['min'] : '' }}</b>
